...
<div class="row">
    <div class="col-md-8">
        ...
        {{ Form::number('gross_weight', trans('product::attributes.gross_weight'), $errors, $product, ['min' => 0, 'required' => true]) }}
        {{ Form::number('net_weight', trans('product::attributes.net_weight'), $errors, $product, ['min' => 0, 'required' => true]) }}
    </div>
</div>
