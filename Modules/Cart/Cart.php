...
class Cart extends DarryldecodeCart implements JsonSerializable
{
    ...
    {
        $v = $this->items()->sum(function ($cartItem) {
            return $cartItem->product->gross_weight * $cartItem->qty;
        });
        return $v;
    }
    ...
    {
        return $this->shippingMethod()->cost()->multiply($this->totalWeight());
    }
    ...
    public function total()
    {
        return $this->subTotal()
            ->add($this->shippingMethod()->cost()->multiply($this->totalWeight()))
