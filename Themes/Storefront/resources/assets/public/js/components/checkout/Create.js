...
export default {
    ...
    data() {
        return {
            ...
            stripeError: null,
            cart_after_order_success: null,
            form_after_order_success: null,
        };
    },
    ...
    created() {
        if(localStorage.getItem('form_after_order_success') !== null){
            this.form_after_order_success = JSON.parse(localStorage.getItem('form_after_order_success'));
            localStorage.removeItem('form_after_order_success');
        }
        if(localStorage.getItem("cart_after_order_success") != null){
            this.cart_after_order_success = JSON.parse(localStorage.getItem('cart_after_order_success'));
            localStorage.removeItem('cart_after_order_success');
        }
    ...
    methods: {
        ...
        placeOrder() {
            ...
            localStorage.setItem('cart_after_order_success',JSON.stringify(this.cart));
            localStorage.setItem('form_after_order_success',JSON.stringify(this.form));
            $.ajax({
                method: 'POST',
